...
class NewsAdapter(private val _context: Context, private val _listDataHeader: List<String>,
                                               private val _listDataChild: HashMap<String, List<AdlNewsItem>>) : BaseExpandableListAdapter() {
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int,
        ...
        val childText = getChild(groupPosition, childPosition) as AdlNewsItem
